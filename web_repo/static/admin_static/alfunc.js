...
function edit_borrow_admin(respond) {
	var url = document.getElementById('url_static').innerHTML+"admin_static/edit_borrow_admin.html";
...
function call_main_category(respond){
	var url = document.getElementById('url_static').innerHTML+"admin_static/list_category.html";
	$("#page-inner").load(url, function () {
		var j = 1;
...
{
	var url = document.getElementById('url_static').innerHTML+"admin_static/edit_category.html";
	$("#page-inner").load(url, function () {
		var old_name = name;
